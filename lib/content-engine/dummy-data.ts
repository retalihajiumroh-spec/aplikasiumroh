  ...
  carouselSlides: [
    {
      ...
      gradient: "from-emerald-600/90 via-teal-700/80 to-emerald-950",
    },
    {
      id: "c2",
      title: "Hotel dekat Haram",
      subtitle: "Arti waktu ibadah maksimal",
      gradient: "from-teal-600/85 via-cyan-800/70 to-emerald-950",
    },
    {
      id: "c3",
      title: "Manasik intensif",
      subtitle: "Panduan praktis per sesi",
      gradient: "from-emerald-500/80 via-green-900/75 to-black/80",
    },
    {
      id: "c4",
      title: "Kuota Ramadan",
      subtitle: "Segera amankan seat",
      gradient: "from-amber-600/70 via-emerald-900/80 to-emerald-950",
    },
  ],
  headlines: [

  ...
  return (
    <section className="glass-panel rounded-2xl border border-emerald-500/10 p-5 sm:p-6">
      <div className="border-b border-emerald-500/10 pb-4">
        ...
        <p className="mt-1 text-sm text-emerald-200/50">{description}</p>
      </div>
        ...
        {items.map((item, i) => {
          ...
          return (
            <motion.li
              ...
              className="flex gap-3 rounded-xl border border-emerald-500/10 bg-emerald-950/30 p-3 transition hover:border-amber-400/25"
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-emerald-400/60">
                  ...
                  {item.amountIdr !== undefined ? (
                    <span className="font-mono font-semibold text-amber-200/90">{formatIdrCompact(item.amountIdr)}</span>
                  ) : null}

...
function kindMeta(kind: OverviewActivityKind) {
  switch (kind) {
    ...
    case "payment":
      return { label: "Bayar", className: "border-purple-400/30 bg-purple-500/12 text-purple-100" };
    case "document":
...
export function OverviewActivityFeed({ items }: { items: OverviewActivityItem[] }) {
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm text-purple-200/55">Aktivitas terbaru di seluruh operasi.</p>
          ...
          return (
            ...
            >
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-[11px] text-purple-500/50">{item.at}</span>
              </div>

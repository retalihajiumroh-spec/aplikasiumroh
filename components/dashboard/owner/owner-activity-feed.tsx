...
function kindMeta(kind: ActivityFeedKind) {
  switch (kind) {
    ...
    case "payment":
      return { label: "Pembayaran", className: "border-emerald-400/30 bg-emerald-500/12 text-emerald-100" };
    case "document":
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-2 rounded-full border border-emerald-400/20 bg-emerald-500/10 px-3 py-1.5">
          ...
          <span className="text-[10px] font-semibold uppercase tracking-wide text-emerald-200/90">Live</span>
        </div>
      </div>
          ...
          return (
            ...
            >
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-[11px] font-medium text-emerald-400/70">{item.at}</span>
              </div>

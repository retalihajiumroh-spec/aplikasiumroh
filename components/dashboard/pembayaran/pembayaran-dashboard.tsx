      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-400/90 sm:text-base">
            Antrian settlement VA, transfer, dan QRIS — sinkron dengan Booking & Payment untuk rekonsiliasi harian.
          </p>
        </motion.header>

        <div className="mt-10 overflow-hidden rounded-2xl border border-emerald-500/10 glass-panel">

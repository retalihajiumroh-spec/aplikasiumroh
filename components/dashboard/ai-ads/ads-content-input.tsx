...
export function AdsContentInput({
  ...
  return (
    ...
    >
      <h2 className="text-lg font-semibold text-purple-50">Input kampanye</h2>
      ...
      <p className="mt-3 text-center text-[11px] text-purple-500/50">Simulasi lokal — tidak ada panggilan API.</p>
    </motion.section>
  );
}

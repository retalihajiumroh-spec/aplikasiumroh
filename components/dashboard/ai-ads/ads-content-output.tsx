      ...
      <div className="mt-6 space-y-5">
        <div className="glass-card rounded-xl p-4">
          <div className="flex items-center justify-between gap-2">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-purple-300/60">Caption utama</h3>
            <CopyTextButton text={data.primaryCaption} />
          </div>
          <p className="mt-3 whitespace-pre-line text-sm leading-relaxed text-purple-100/90">{data.primaryCaption}</p>
        </div>

        <div className="glass-card rounded-xl p-4">
          <div className="flex items-center justify-between gap-2">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-purple-300/60">Caption alternatif</h3>
            <CopyTextButton text={data.altCaption} label="Salin" />
          </div>
          <p className="mt-3 whitespace-pre-line text-sm leading-relaxed text-purple-100/85">{data.altCaption}</p>
        </div>

        <div className="glass-card rounded-xl p-4">
          <h3 className="text-xs font-semibold uppercase tracking-wider text-purple-300/60">Suggested hashtags</h3>
        ...
        <div className="glass-card rounded-xl p-4">
          <div className="flex items-center justify-between gap-2">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-purple-300/60">Ad script preview</h3>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="glass-card rounded-xl border border-purple-400/15 bg-purple-500/[0.06] p-4">
          ...
          <div className="glass-card rounded-xl p-4">
            <div className="flex items-center justify-between gap-2">
              <h3 className="text-xs font-semibold uppercase tracking-wider text-purple-300/60">Headline</h3>
              <CopyTextButton text={data.headline} />
            </div>
            <p className="mt-2 text-sm font-medium leading-snug text-purple-50">{data.headline}</p>
          </div>
        </div>
      </div>
    </motion.section>

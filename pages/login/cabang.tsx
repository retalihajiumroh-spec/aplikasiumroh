    ...
    <>
      ...
      <main className="flex min-h-dvh flex-col items-center justify-center px-4 py-12">
        ...
        <div className="glass-panel w-full max-w-md rounded-2xl border border-violet-400/25 p-6 shadow-2xl sm:p-8">
          ...
          <h1 className="mt-3 text-center text-2xl font-semibold tracking-tight text-purple-50">Login Cabang</h1>
          <p className="mt-2 text-center text-sm text-purple-200/55">Portal staf kantor cabang — jamaah, booking, dan laporan harian.</p>
          ...
          <div className="mt-5 flex flex-col items-center gap-3 text-center text-sm">
            <Link href="/forgot-password" className="text-violet-200/95 underline-offset-2 hover:text-violet-100 hover:underline">
              Lupa kata sandi?
            </Link>
            <p className="text-purple-200/55">
              ...
              <Link
                ...
                className="font-semibold text-violet-200/95 underline-offset-2 hover:text-violet-100 hover:underline"
              >
                Daftar cabang
              </Link>
            </p>

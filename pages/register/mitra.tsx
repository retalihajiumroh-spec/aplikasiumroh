    ...
    <>
      ...
      <main className="flex min-h-dvh flex-col items-center justify-center px-4 py-12">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 18% 0%, rgba(56, 189, 248, 0.12), transparent 42%), radial-gradient(circle at 88% 48%, rgba(52, 211, 153, 0.09), transparent 40%)",
          }}
        />
        ...
        <div className="glass-panel w-full max-w-md rounded-2xl border border-sky-500/20 p-6 shadow-2xl sm:p-8">
          ...
          <p className="mt-2 text-center text-sm text-emerald-200/55">Buat akun portal mitra — penanggung jawab &amp; kontak utama.</p>
